...
1. Copy the [`sast.xsl`](https://gitlab.com/parasoft/cpptest-gitlab/-/blob/master/xsl/cpptest-standard-sast15/sast.xsl) file into the C/C++test installation root folder (`<CPPTEST_INSTALL_DIR>`).
